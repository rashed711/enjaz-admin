...
function renderDrawer(data){
    ...
    const svgFlags = {
        ...
        'ID': '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 480" width="18" height="13" style="border-radius:2px;vertical-align:middle;display:inline-block;"><rect width="640" height="240" fill="#ce1126"/><rect y="240" width="640" height="240" fill="#ffffff"/></svg>',
