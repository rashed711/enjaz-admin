...
import { Product, ProductType, Unit, Currency, PurchaseInvoiceStatus } from '../types';
import { useProducts } from '../contexts/ProductContext';
import AddProductModal from './AddProductModal';
import { PurchaseInvoiceState, PurchaseInvoiceItemState } from '../pages/PurchaseInvoiceEditorPage';
...
const PurchaseInvoiceEditorForm: React.FC<PurchaseInvoiceEditorFormProps> = ({ invoice, setInvoice, onSave, isSaving, onCancel, saveError }) => {
    ...
    const updateItemDescription = useCallback((item: PurchaseInvoiceItemState, product?: Product): string => {
    ...
    const addItem = () => {
        const newItem: PurchaseInvoiceItemState = {
        ...
        <>
            ...
            <div className="bg-card p-6 rounded-lg shadow-sm max-w-7xl mx-auto border border-border">
                 ...
                 <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    ...
                    <select name="status" value={invoice.status} onChange={handleInputChange} className={inputClasses}>
